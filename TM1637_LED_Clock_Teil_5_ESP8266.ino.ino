...
static const byte APSTANameLen = 32;
...
void SetDefaultWiFiConfig ()
{
  ...
  strncpy( MyWiFiConfig.APSTAName, "My_Clock", sizeof(MyWiFiConfig.APSTAName) );
  len = strlen(MyWiFiConfig.APSTAName);
  MyWiFiConfig.APSTAName[len + 1] = '\0';
...
void handleRoot() {
  ...
  server.sendContent(temp);
  temp = "";
  temp += "<br><table border=2 bgcolor = white width = 500 cellpadding =5 ><caption><p><h3>Systemlinks:</h2></p></caption>";
  temp += "<tr><th><br>";
